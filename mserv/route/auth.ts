...
import jwts = require('jsonwebtoken')
...
// auth section ////////////////////////////
export function authUser(userEmail, password) { // you can use this(A)
...
export function authToken (token) { // or this(B) on other than 2 call
	const promise = new Promise(function(resolve, reject){
